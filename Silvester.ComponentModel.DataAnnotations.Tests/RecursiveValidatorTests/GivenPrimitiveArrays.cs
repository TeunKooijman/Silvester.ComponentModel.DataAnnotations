...
{
    public class GivenPrimitiveArrays
    {
        [Fact]
        public void GivenValidUninitializedPrimitiveArrays_WhenValidateRecursively_ThenCorrectValidationResults()
        {
            RecursiveValidator validator = new RecursiveValidator(null);
            List<ValidationResult> results = validator.ValidateObjectRecursively(PrimitiveArray.Valid());
            Assert.Empty(results);
        }

        [Fact]
        public void GivenValidNullablePrimitiveArrays_WhenValidateRecursively_ThenCorrectValidationResults()
        {
            RecursiveValidator validator = new RecursiveValidator(null);
            List<ValidationResult> results = validator.ValidateObjectRecursively(NullablePrimitiveArray.Valid());
        ...
        {
            RecursiveValidator validator = new RecursiveValidator(null);
            List<ValidationResult> results = validator.ValidateObjectRecursively(new NullablePrimitiveArray());
